  ...
  return (
    <>
      ...
      >
        <ul className="flex space-x-4">
          {types.map((type) => (
            <li key={type.name}>
              <a
                href={type.link}
                className={`px-4 py-2 rounded-lg transition-all ${currentPage === type.link
              ...
              <div className="absolute left-0 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg dark:bg-gray-800">
                <ul className="flex flex-col gap-2 p-2 max-h-[50vh] overflow-y-auto">
                  {categories.map((category) => (
                    <li key={category.name} className="hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md">
                      <a
                        href={category.link}
        ...
        <motion.div
          className="relative max-w-lg border border-gray-300 rounded-md flex items-center dark:border-gray-600 bg-white dark:bg-gray-800 shadow-md mr-20"
